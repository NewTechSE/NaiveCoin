...
import { getPublicKey, getTransactionId, signTxIn, Transaction, TxIn, TxOut, UnspentTxOut } from '@dtos/transaction.dto';

const EC = new ec('secp256k1');
const privateKeyLocation = process.env.PRIVATE_KEY || './src/config/private_key';
